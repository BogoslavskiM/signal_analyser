(function () {
  ...
  function samples(state) {
    ...
    var visible=helper ? helper.normalizeVisibility(state.sampleColumnVisibility) : {magnitude:true,square:true,square_root:true,signed_square_root_magnitude:true};
    var columns=helper ? helper.visibleColumns(visible) : [{id:"sample_index",label:"№ точки"},{id:"time",label:"Время"},{id:"value",label:"Значение"},{id:"magnitude",label:"Модуль"},{id:"square",label:"Квадрат"},{id:"square_root",label:"Корень"},{id:"signed_square_root_magnitude",label:"Корень из модуля × знак"}];
    var width=helper ? helper.minimumTableWidth(visible) : 1182;
