...
16. Классифицируй расчёт как быстрый или долгий инженерным решением backend-разработчика. Используй измерения из backend logs и при необходимости привлекай tester для Engee contract/performance checks.
...
- Engee-dependent поведение фиксируй тестами в `test/engee`.
