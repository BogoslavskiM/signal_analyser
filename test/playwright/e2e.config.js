...
module.exports = {
  app: {
    ...
    // Production-only browser target policy.  Devhub/current-tab fallbacks are
    // deliberately unsupported for this project.
    pageUrlMatch: "https://engee.com/prod/user/",
    allowedOrigins: ["https://engee.com"],
    ...
    testIds: {
      ...
      signalsAddAction: "signals-add-action",
      signalsAddMenu: "signals-add-menu",
      signalsAddWorkspaceAction: "signals-add-workspace-action",
      signalsAddSelectionAction: "signals-add-selection-action",
      signalsCopyAction: "signals-copy-action",
      signalsDeleteAction: "signals-delete-action",
      signalsWorkspaceDialog: "signals-workspace-dialog",
      signalsWorkspaceRefresh: "signals-workspace-refresh",
      signalsWorkspaceLoading: "signals-workspace-loading",
      signalsWorkspaceEmpty: "signals-workspace-empty",
      signalsWorkspaceList: "signals-workspace-list",
      signalsWorkspaceSelectionCount: "signals-workspace-selection-count",
      signalsWorkspaceSampleRateGroup: "signals-workspace-sample-rate-group",
      signalsWorkspaceSampleRateInput: "signals-workspace-sample-rate-input",
      signalsWorkspaceSampleRateError: "signals-workspace-sample-rate-error",
      signalsWorkspaceBatchError: "signals-workspace-batch-error",
      signalsWorkspaceRetry: "signals-workspace-retry",
      signalsWorkspaceSubmit: "signals-workspace-submit",
      signalsWorkspaceCancel: "signals-workspace-cancel",
      signalsWorkspaceClose: "signals-workspace-close",
      signalsWorkspaceSuccess: "signals-workspace-success",
      signalsWorkspaceSuccessCount: "signals-workspace-success-count",
      signalsWorkspaceDone: "signals-workspace-done",
      signalsDeleteDialog: "signals-delete-dialog",
      signalsDeleteConfirm: "signals-delete-confirm",
      signalsDeleteCancel: "signals-delete-cancel",
      signalsDeleteDone: "signals-delete-done",
      signalsActionError: "signals-action-error",
      signalsToolbarError: "signals-toolbar-error",
