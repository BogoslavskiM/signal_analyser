...
assert.equal(config.app.testIds.displaySelectionContractErrorState, "display-selection-contract-error-state");
assert.equal(config.app.testIds.activePlotContractErrorState, "display-active-plot-contract-error-state");
...
assert.equal(config.app.testIds.persistenceSettings, "persistence-settings");
assert.equal(config.app.testIds.persistenceLeakageInput, "persistence-leakage-input");
assert.equal(config.app.testIds.persistenceLeakageValue, "persistence-leakage-value");
assert.equal(config.app.testIds.persistenceLeakageError, "persistence-leakage-error");
...
assert.equal(config.features["display-selection-snapshot"], false);
assert.equal(config.features["active-plot-snapshot"], false);
