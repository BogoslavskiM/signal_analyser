...
@testset "Compatibility Peaks routes expose typed Extrema API" begin
 ...
 @test occursin("number_of_peaks",service)&&occursin("minimum_height",service)&&occursin("minimum_distance_samples",service)&&occursin("threshold",service)&&occursin("mode",service)
