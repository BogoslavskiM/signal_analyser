...
module.exports = async function testV5RebaseStaticContract(assert) {
  ...
  assert(layouts.includes("layoutLabel(activeDisplayId)") && !app.includes("layoutLabel = \"1 × 1\""), "layout trigger label must derive from authoritative state, never a seeded 1×1 value");
