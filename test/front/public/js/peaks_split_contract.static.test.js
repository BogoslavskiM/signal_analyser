...
assert((html.match(/data-settings-page=/g)||[]).length===3&&/data-settings-page="display"[\s\S]*data-settings-page="screen"[\s\S]*data-settings-page="peaks"/.test(html)&&html.includes(">Экстремумы<")&&!html.includes('data-settings-page="time"'),"right sidebar must expose Area, Screen and Extrema tabs");
